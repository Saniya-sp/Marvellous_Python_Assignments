...
StudyHours
Attendence
Compare the accuracy with full-feature model. Is the model still performing well?"""
...
def main():
    ...
    X_new = df.drop(columns=['PreviousScore','AssignmentsCompleted','SleepHours','FinalResult'])
    Y = df['FinalResult']
...
# Observation:
#     Yes, model perfomrs wll. There is no change in accuracy score. Score is 100% in both cases.
