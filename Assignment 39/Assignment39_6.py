...
Compare their testing accuracy and write your observation 
    """
...
def main():
    ...
    print('testing_accuracies: ',testing_accuracies)
...
# Observation:
    # Testing accuracy remains same (100%) for different depths.