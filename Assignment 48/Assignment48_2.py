"""Using same dataset from above question, calculate model performance
Tasks:
    Predict all Y values using regression equation
    Calculate 
        Mean squared error
        R square score
Show all intermediate calculation
...
def MarvellousPredictor():
    ...
    ###############################################
    # Step 6 : Predict all Y values
    ###############################################

    print(border)
    print("Step 6 : Predict all Y values")
    print(border)
    ...
    print(border)
    print("Step 7 : Calculate Mean Squared Error")
    print(border)
    ...
    print(border)
    print("Step 8 : Calculate R Square Score")
    print(border)
    ...
    for i in range(n):
        ...
        total_sum_square = total_sum_square + square_difference

        print(
            f"Y = {Y[i]}, "
            f"Ybar = {Ybar}, "
            f"(Y - Ybar)^2 = {square_difference:.2f}"
        )

    # R square formula
    r2 = 1 - (sum_squared_error / total_sum_square)

    print("Total Sum of Squares:", total_sum_square)
